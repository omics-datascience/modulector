...
*   **¿De dónde sale `gene_aliases.csv` y está documentado?**: **NO está documentado**. No hay instrucciones en `DEPLOYING.md` sobre de dónde descargar este archivo ni cómo cargarlo. 

### B. Propuesta de Solución para `GeneAliases`
1.  **Documentar el origen**: Se debe investigar y documentar en `DEPLOYING.md` los pasos exactos para que un administrador descargue el archivo `gene_aliases.csv`.
